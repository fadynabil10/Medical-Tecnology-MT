...
<link rel="stylesheet" href="../styles/confirm-pharmacy-style.css">
</head>
<body>
        ...
        <div id="signup">   
          ...
          <form action="/" method="post">
            ...
            <div class="field-wrap">
              ...
              <input type="text" required autocomplete="off" placeholder = 'Enter id' style="display: inline; width: 83%;"/>
            </div>

              <div class="field-wrap">
                <h1 style="color: black; font-size: 40px; display: inline;">Code : </h1>
              <input type="text"required autocomplete="off" placeholder = 'Enter code'style="display: inline; width: 70%;"/>
            </div>
          
          <button style="border: 0; outline: none;border-radius: 0;padding: 15px 0;font-size: 2rem;font-weight: 600;height: 70px;text-transform: uppercase;letter-spacing: .1em;background: #1ab188;color: #ffffff;" type="submit" class="button button-block1"/>Confirm
              </button>
          </form>
