...
<div class="super_container">
   ...
   <div class="container-doctor">
        <div class="main-section">
            <div class="column-one">
                ...
                <div class="profile-info c1">
                    <h4>Doctor <span>Omar reda</span>
                        <span class="icon"><img src='../images/edite.png'class = 'edit-icon rounded float-right d-edit-icon'/></span></h4>
                    ...
                    <h5>
                        ...
                        <span class="icon"><img src='../images/edite.png'class = 'edit-icon rounded float-right'/></span>
                    </h5>
                        ...
                        <div class="timing">
                            <div class="row time-content">
                                ...
                                <div class="col-sm">
                                    ...
                                    <button class='btn-book Nonbooked' id='btn-booked' onclick='cl()'><span id="btn-text">Non Booked</span></button>
                                </div>
                                <div class="col-sm">
                            ...
                            <div class="row time-content">
                                <div class="col-sm">
                                    <h6 class="t-clo">03:00 PM</h6>
                                    <button class='btn-book booked' id="btn-booked" onclick='cl()'><span id="btn-text">Booked</span></button>
                                </div>
                                <div class="col-sm">
                                    <h6 class="t-clo">03:30 PM</h6>
                                    <button class='btn-book Nonbooked' id='btn-booked' onclick='cl()'><span id="btn-text">Non Booked</span></button>
                                </div>
                                <div class="col-sm">
                                    <h6 class="t-clo">04:00 PM</h6>
                                    <button class='btn-book Nonbooked' id='btn-booked' onclick='cl()'>
                                        <span id="btn-text">Non Booked</span></button>
                                </div>
                            </div>
                        </div>
                    </div>
       ...
       <div class='col-xl- feed-back'>
        ...
        <button type="button" data-toggle="modal" data-target="#book" class="btn btn-primary btn-lg btn-block btn-myapp">Start Working</button>
    </div>
...
//    function cl() {
//      var element = document.getElementById('btn-booked');
//      var textBtn = document.getElementById('btn-text');
//        if (textBtn.innerHTML === 'Non Booked') {
//            element.innerHTML = 'Booked';
//            element.classList.toggle("Nonbooked");
//            element.classList.toggle("booked");
//        }
//        else{
//             element.innerHTML = 'Non Booked';
//             element.classList.toggle("booked");
//             element.classList.toggle("Nonbooked");
//        }
//    }
